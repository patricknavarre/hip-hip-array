...
const favoriteFish = [];
favoriteFish.push('striped bass');
favoriteFish.push('scup');
favoriteFish.unshift('black sea bass');
favoriteFish.push('false albacore');
favoriteFish.unshift('rock fish');


for (let i = 0; i < favoriteFish.length; i++) {
  // console.log(favoriteFish[i]);
}
